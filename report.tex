...
\usepackage{luacode}  % Load this early for Lua safety hooks
...
\usepackage{fontspec}  % Better Unicode support
\setmonofont{Latin Modern Mono}

% pyluatex setup with dynamic executable path
...
-- Prevents: "attempt to index a nil value (upvalue 'tcp')"
-- Ideally: pyluatex should be updated to handle this gracefully.
...
\input{pycode/nb_snippets/auto_nb_figures}
